...
class EntryFile
  ...
  def organizer_name
    doc.at_css("concours > organisateur").attr("nom").to_s.titleize
  end
  ...
  def show_name
    doc.at_css("concours").attr("nom").to_s.titleize
  end
  ...
  def officials
    doc.css("officiel").each do |officiel|
      ...
      official.first_name = officiel["prenom"].to_s.titleize
      official.last_name = officiel["nom"].to_s.titleize
  ...
  def riders
    doc.css("cavalier").each do |cavalier|
      ...
      rider.first_name = cavalier["prenom"].to_s.titleize
      rider.last_name = cavalier["nom"].to_s.titleize
      rider.club = Club.where(ffe_id: cavalier["club"]).first_or_create(name: cavalier["nom_club"].to_s.titleize)
  ...
  def horses
    doc.css("equide").each do |equide|
      ...
      horse.color = equide["code_robe"].to_s.titleize
      ...
      if equide.at_css("> mere pere")
        horse.dam_sire = Equipe::HorseName.new(equide.at_css("> mere pere").attr("nom")).normalize
      end
      horse.save!
